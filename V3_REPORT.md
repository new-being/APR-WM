...
The controlled V4-min experiment implements this next step with a finite operator library, active candidate discrimination, held-out acceptance, and proposal/selection oracles; see [`V4_REPORT.md`](V4_REPORT.md).
