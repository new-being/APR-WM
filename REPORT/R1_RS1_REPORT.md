...
Date: 2026-08-15  
Prereg: `R1_RS1_PREREG.md` (frozen before formal run)  
...
- **RS1A** (`R1_RS1A_PREREG.md`): multi-evidence inadequacy detection; freeze
  revision/acceptance/H32; primary endpoint is trigger ROC/PR, not recovery.
- **RS1B** (`R1_RS1B_PREREG.md`): locked draft until RS1A finishes; dynamics
