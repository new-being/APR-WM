...
The next bottleneck is no longer proposal recall. V5-min therefore freezes the library and isolates candidate discrimination, sequential evidence, and acceptance under finite noisy interventions; see [`REPORT/REP/R0/V5_REPORT.md`](REPORT/REP/R0/V5_REPORT.md). Compositional operator generation is deferred until this discrimination boundary is understood.
