...
The justified next step is not a larger operator library. V6 therefore freezes proposal and selection, then studies adaptive held-out evidence under explicit false-revision and missed-revision costs; see [`REPORT/REP/R0/V6_REPORT.md`](REPORT/REP/R0/V6_REPORT.md).
