...
Next domain: **R5 self-stress STOPPED at D0** (`GO=false`)
(`REPORT/REP/R5/R5_SELFSTRESS_FAMILY_STOP.md`); contact family paused; no encoder
...
**R4 family STOP** (`REPORT/REP/R4/R4_FAMILY_STOP.md`). No C3.
R5 prereg is admission only (`REPORT/REG/R5/R5_PREREG.md`, not run):
