...
Date: 2026-08-15  
Prereg: `REPORT/REG/R1/R1_RS1A5_PREREG.md`  
...
RS1B remains **locked for formal run** until `REPORT/REG/R1/R1_RS1B_PREREG.md` numbers are
...
| Stage | Status |
|-------|--------|
| RS1A.5 | **passed** (frozen) |
| RS1B | **formal complete, GO=false** (intake = \(\mathcal P_{\mathrm{rev}}\) only) |
| RS1C / RS2 | locked |

## Next

**RS1A stage frozen** — see `REPORT/REP/R1/R1_RS1A_STAGE_FREEZE.md`.

**RS1B formal complete** — `REPORT/REP/R1/R1_RS1B_REPORT.md` (`RS1B_GO=false`).
Do not reopen detector/VoI/tolerance after H32. RS1C/RS2 stay locked.
