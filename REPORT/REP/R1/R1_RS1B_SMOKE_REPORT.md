...
Date: 2026-08-15  
Prereg: REPORT/REG/R1/R1_RS1B_PREREG.md  
Artifacts: runs/r1_rs1b/smoke/  
Status: **PLUMBING PASSED.** Formal confirmatory matrix has since been run; see `REPORT/REP/R1/R1_RS1B_REPORT.md`. This smoke file must not be re-read as a scientific result.
...
The 30-episode held-out matrix was later run without changing gates.
`RS1B_GO` is set only in `REPORT/REP/R1/R1_RS1B_REPORT.md`, not here.
