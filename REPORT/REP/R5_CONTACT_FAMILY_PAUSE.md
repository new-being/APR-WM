...
Canonical ledger for this pause. Numbers: `REPORT/REP/R5_I0_REPORT.md`,
`REPORT/REP/R5_I0_V2_REPORT.md`, `REPORT/REP/R5_I0_V3_REPORT.md`.
...
only (`REPORT/REG/R5_I0_SELFSTRESS_PREREG.md`). It does **not** unpause
this contact file. I0 `PASS=false` on scalar \(C\) remains frozen.
R5-I1-SELFSTRESS (`REPORT/REP/R5_I1_SELFSTRESS_REPORT.md`) tests
