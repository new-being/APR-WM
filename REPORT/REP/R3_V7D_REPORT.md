...
Date: 2026-08-16  
Prereg: `REPORT/REG/R3_V7D_PREREG.md`  
Depends on: `REPORT/REP/R3_V7C5_REPORT.md` (scientific matrix; `V7C.5_GO=false` is **not** a lock)  
...
capacity. See `REPORT/REG/R4_C0_PREREG.md`. There is **no V7E**.
