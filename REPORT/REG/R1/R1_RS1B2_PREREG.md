...
Date: 2026-08-16  
Status: **FROZEN; formal completed** — see `REPORT/REP/R1/R1_RS1B2_REPORT.md` (`RS1B.2_GO=true`)  
Depends on: `REPORT/REP/R1/R1_RS1B1_REPORT.md` (`RS1B.1_GO=false`; intermediate band empty)  
...
be drafted as a *new* policy hypothesis (`REPORT/REG/R1/R1_RS1C_PREREG.md`),
