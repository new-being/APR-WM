...
Depends on: `REPORT/REP/R3/R3_V7_STAGE_FREEZE.md`, `REPORT/REP/R3/R3_V7D_REPORT.md`  
...
- `R4_I0_PASS` (`REPORT/REG/R4/R4_I0_PREREG.md`) — many-to-one
  local/global counterexample (I0 v2 stiffness swap);
- `R4_I1_PASS` (`REPORT/REG/R4/R4_I1_PREREG.md`) — over-complete \(h^{S}\)
...
epistemic target (`REPORT/REG/R4/R4_C1_PREREG.md`), not a C0 patch.
