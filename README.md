...
- **R7**：switch certification。**R7-P0 `PASS=true`**；**R7-A0 `GO=true`**；
  ...
  **CAP-X2-P0 PASS / planning DISABLED** + **CAP-X2 \(\rho\) sweep IN PROGRESS**
  （\(M=M_1\land M_2\) predictive only）+
  **PLAN-X / PLAN-X0 prereg FROZEN**（与 CAP 正交；提案网络未开；R10 锁定）
  ...
  [REPORT/REG/CAPX/CAPX2_PREREG.md](REPORT/REG/CAPX/CAPX2_PREREG.md)、
  [REPORT/REG/PLANX/PLANX_PREREG.md](REPORT/REG/PLANX/PLANX_PREREG.md)、
  [REPORT/REG/PLANX/PLANX0_PREREG.md](REPORT/REG/PLANX/PLANX0_PREREG.md)。
