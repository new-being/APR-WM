...
- **R7**：switch certification。**R7-P0 `PASS=true`**；**R7-A0 `GO=true`**；
  ...
  **RoboTwin-X0-P0 PASS**；**smoke PASS**（2026-08-27 RTX 5090 Vulkan）；
  **RoboTwin-X0 RAN**，容量替代 **WITHHELD**（弱激励 / identity-physics /
  \(\phi\) 未辨识 / latent rollout 不稳；runner 的 `physics_capacity_shift`
  不是预注册 PASS）；**X0R = RAN / `excitation_failure`**（G1 力可审计 PASS；
  G0 恒等仍优于欧拉；G2 \(\phi\) 未 ident；G3 latent rollout 炸；
  **非** `instrument_ready`；瓶颈是柜体 \(F_{\mathrm{phy}}\) **结构/力会计**
  不是 \(\Delta s=0\)；下一步 **RTWX-X0S**，不是估 \(\phi\) / XL0 / 视觉）；**TASK-X0 = RAN / FAIL**
  （仪器/表示测试未过，**不能**写成「任务进度无规划价值」；
  cup/stamp `p_no_nll`：本探针未额外压缩 \(H(A\mid s,g)\)；
  cabinet `coverage_hole`：仪器不足，**不是** \(p_t\) 无决策价值；
  **TASK-X1 LOCKED**；**TASK-XL = DESIGN FROZEN ONLY / LOCKED**；
  **RTWX-X0S = RAN / `timing_mismatch`**；**X0F = RAN / `force_channel_unresolved`**
  （五条力通道 × 三 \(\ddot q\) × lag \(\{\pm2,\ldots\}\) 均未达 \(\min|\rho|\ge 0.3\)；
  现有 wrapper **不适合** physics-capacity；numpy 自检 PASS）
  TASK-XL 学习 \(z_g,z^p\) 仅设计冻结，XL0 未跑；扩散仍 LOCKED；
  优先级 **X0S > φ-ID > capacity > TASK-XL > visual > diffusion**）
  [REPORT/REG/RTWX/robot_dynamics/RTWX0S_PREREG.md](REPORT/REG/RTWX/robot_dynamics/RTWX0S_PREREG.md)、
  [REPORT/REP/TASKX/TASKX0_REPORT.md](REPORT/REP/TASKX/TASKX0_REPORT.md)、
  [REPORT/REG/TASKX/TASKXL_PREREG.md](REPORT/REG/TASKX/TASKXL_PREREG.md)、
  [REPORT/REP/RTWX/robot_dynamics/RTWX0_REPORT.md](REPORT/REP/RTWX/robot_dynamics/RTWX0_REPORT.md)、
  [REPORT/REG/RTWX/robot_dynamics/RTWX0R_PREREG.md](REPORT/REG/RTWX/robot_dynamics/RTWX0R_PREREG.md)、
  [REPORT/REG/TASKX/TASKX_PREREG.md](REPORT/REG/TASKX/TASKX_PREREG.md)、
  [REPORT/REG/TASKX/TASKX0_PREREG.md](REPORT/REG/TASKX/TASKX0_PREREG.md)、
  [REPORT/REP/RTWX/robot_dynamics/RTWX0_P0_REPORT.md](REPORT/REP/RTWX/robot_dynamics/RTWX0_P0_REPORT.md)、
